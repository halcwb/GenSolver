...
// Properties
let buildDir = "./build/"
let project = "src/Informedica.GenSolver.Lib/Informedica.GenSolver.Lib.fsproj"
...
Target.create "test" <| fun _ ->
    ...
    let cmd = "run"
    let args = "--project tests/Informedica.GenSolver.Tests/Informedica.GenSolver.Tests.fsproj"
    let result = 
        DotNet.exec 
